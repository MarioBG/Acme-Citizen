...
public class ConfigurationServiceTest extends AbstractTest {
	...
	private void templateEdit(final String userName, final String words, final Class<?> expected) {
	...
	public void driverListTabooWords() {
		...
		for (int i = 0; i < testingEditData.length; i++)
			this.templateListTabooWords((String) testingEditData[i][0], (Class<?>) testingEditData[i][1]);
	}

	private void templateListTabooWords(final String userName, final Class<?> expected) {
	...
	public void driverListArticlesWithTabooWords() {
		...
		for (int i = 0; i < testingEditData.length; i++)
			this.templateListArticleswithTabooWords((String) testingEditData[i][0], (Class<?>) testingEditData[i][1]);
	}

	private void templateListArticleswithTabooWords(final String userName, final Class<?> expected) {
	...
	public void driverListNewspapersWithTabooWords() {
		...
		for (int i = 0; i < testingEditData.length; i++)
			this.templateListNewspapersWithTabooWords((String) testingEditData[i][0], (Class<?>) testingEditData[i][1]);
	}

	private void templateListNewspapersWithTabooWords(final String userName, final Class<?> expected) {
	...
	public void driverListChirpWithTabooWords() {
		...
		for (int i = 0; i < testingEditData.length; i++)
			this.templateListChirpWithTabooWords((String) testingEditData[i][0], (Class<?>) testingEditData[i][1]);
	}

	private void templateListChirpWithTabooWords(final String userName, final Class<?> expected) {
