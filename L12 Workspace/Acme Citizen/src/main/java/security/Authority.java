...
public class Authority implements GrantedAuthority {
	...
	public static final String	GOVAGENT	= "GOVAGENT";
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.GOVAGENT + "|" + Authority.BANKAGENT + "|" + Authority.CITIZEN + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority.setAuthority(Authority.GOVAGENT);
